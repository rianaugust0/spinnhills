    ...
    try {
        ...
        if (grantType === 'spin') {
            ...
            addDocumentNonBlocking(collection(firestore, 'prizes'), {
                ...
                userPhone: client.id, // Assuming phone is ID
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="bg-dark-gray border-gold/20 text-ice-white">
        ...
        <div className="py-4 space-y-6">
            <RadioGroup defaultValue="spin" onValueChange={(value: GrantType) => setGrantType(value)}>
                <div className="flex items-center space-x-2">
                    <RadioGroupItem value="spin" id="r1" />
                    <Label htmlFor="r1">Liberar apenas 1 giro</Label>
                </div>
                <div className="flex items-center space-x-2">
